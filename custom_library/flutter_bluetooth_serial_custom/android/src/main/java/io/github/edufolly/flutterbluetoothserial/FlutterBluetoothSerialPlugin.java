...
public class FlutterBluetoothSerialPlugin implements MethodCallHandler, RequestPermissionsResultListener, ActivityResultListener, ViewDestroyListener {
    ...
    private BluetoothConnectionWrapper connection;
    // General Bluetooth
    ...
    // Discovery
    private final EventChannel discoveryChannel;
    private EventSink discoverySink;
    private final StreamHandler discoveryStreamHandler;
    ...
    public void onMethodCall(MethodCall call, Result result) {
        ...
        switch (call.method) {
            ...
            case "connect": {
                ...
                connection = new BluetoothConnectionWrapper(id, bluetoothAdapter);
